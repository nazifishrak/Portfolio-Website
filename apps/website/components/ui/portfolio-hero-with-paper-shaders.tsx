  ...
  return (
    <div className="relative min-h-screen overflow-hidden flex">
      ...
      >
        ...
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-lg font-normal mb-8">Nazif.cv</h1>
          <div className="mb-8">
            <h2 className="text-lg font-normal">NAZIF ISHRAK</h2>
        ...
        <div className="mb-12 space-y-1">
          <div className="flex">
            <span className="w-32">Mastercard</span>
            <span className="mx-2">Engineer</span>
            <span className="mx-4">2025 → ....</span>
          </div>
          <div className="flex">
            <span className="w-32">UBC</span>
            <span className="mx-2">CS Degree</span>
            <span className="mx-4">2021 → 2025</span>
          </div>
          <div className="flex">
            <span className="w-32">Side Projects</span>
            <span className="mx-4">2019 → Now</span>
          </div>
        </div>
        ...
        <div className="absolute bottom-8 left-8">
          <div className="flex space-x-4 text-lg font-mono">
            <span>Links</span>
            <a
              href="https://github.com/nazifishrak"
              target="_blank"
            ...
            <a
              href="mailto:nazifishrak@gmail.com"
              className="hover:underline"
            >
              Email
            </a>
