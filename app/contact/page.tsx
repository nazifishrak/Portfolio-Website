        ...
        <div>
            <section className="">
                <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Send Me a
                        Message</h2>
                    <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Ask me anything</p>
                    <form action="#" className="space-y-8">
                        <div>
                            ...
                            <input type="email" id="email"
                                   ...
                                   placeholder="email@nazif.com" required/>
                        </div>
                        <div>
